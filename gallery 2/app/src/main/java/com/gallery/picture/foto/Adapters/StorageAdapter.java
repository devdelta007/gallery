...
public class StorageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public StorageAdapter(Context context, ArrayList<InternalStorageFilesModel> internalStorageList, boolean isGrid) {
                           ...
                           /* if (fileLength == 0) {
                            ...
                            if (type != null) {
                                ...
                                if (type.equalsIgnoreCase("image/jpeg") || type.equalsIgnoreCase("image/png") || type.equalsIgnoreCase("image/webp")) {
                                    ...
                                    Glide.with(context).load(file.getPath()).placeholder(R.drawable.ic_image_placeholder_2)
