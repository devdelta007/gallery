...
public class CustomViewPager extends ViewGroup {
    ...
    public interface OnPageChangeListener {
         ...
         * @see com.tool.file.filemanager.CustomViewPager#SCROLL_STATE_IDLE
         * @see com.tool.file.filemanager.CustomViewPager#SCROLL_STATE_DRAGGING
         * @see com.tool.file.filemanager.CustomViewPager#SCROLL_STATE_SETTLING
         */
